...
open class CreditPayedEventProducer {
    ...
    @Bean
    open fun reactivePayedEventKafkaTemplate(@Value(value = "\${kafka.bootstrapAddress}") bootstrapAddress: String?): ReactiveKafkaProducerTemplate<String, CreditPayedEvent> {
