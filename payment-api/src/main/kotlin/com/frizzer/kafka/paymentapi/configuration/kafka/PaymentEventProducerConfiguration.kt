...
open class PaymentEventProducerConfiguration {
    @Bean
    open fun reactivePaymentEventKafkaTemplate(@Value(value = "\${kafka.bootstrapAddress}") bootstrapAddress: String? = null): ReactiveKafkaProducerTemplate<String, PaymentEvent> {
